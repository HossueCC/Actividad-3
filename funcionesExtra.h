...
float fecha_a_flotante(vector<char*> fechas, int posicion){
    ...
    case 8:
        ...
        break;
    case 9:
        acum_dias =  n1 + n2 + n1 + n3 + n1 + n3 + n1 + n3;
        break;
    case 10:
        acum_dias = n1 + n2 + n1 + n3 + n1 + n3 + n1 + n3 + n1;
        break;
    case 11:
        acum_dias = n1 + n2 + n1 + n3 + n1 + n3 + n1 + n3 + n1 + n3;
        break;
    case 12:
        acum_dias = n1 + n2 + n1 + n3 + n1 + n3 + n1 + n3 + n1 + n3 + n1;
        break;
    case 13:
        acum_dias = n1 + n2 + n1 + n3 + n1 + n3 + n1 + n3 + n1 + n3 + n1 + n3;
        break;
    }
